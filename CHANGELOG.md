...
- Хотфиксы создают раздел с 🩹 и поддерживают запуск подготовки из main/master.
- Дата раздела changelog необязательна; опубликованная история в прежнем формате сохраняется.
- Исправлены проверка корня репозитория и сравнение CRLF/LF в release/hotfix на Windows.
...
- `spectrum release start` проверяет, что текущая dev-ветка содержит `origin/main` или `origin/master`.

## 🚀 [3.0.1] - 2026-08-31

### 🪲 Fixed

- Исправлено создание переносимых путей changelog fragments в Windows.
